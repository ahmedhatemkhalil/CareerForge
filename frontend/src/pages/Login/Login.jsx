...
export default function Login() {
  ...
  // حركات الـ OAuth الموحدة 🌟
  const handleGithubLogin = () => {
    const clientId = "Ov23li20K7kj1leYMBUP";
    localStorage.setItem("oauth_provider", "github"); // حفظ النوع عشان الـ callback
    window.location.href = `https://github.com/login/oauth/authorize?client_id=${clientId}&scope=user:email`;
  };

  const handleGoogleLogin = () => {
    const clientId = "709262554956-ick9aq5hj3342ikue55ljtct3k62bdp9.apps.googleusercontent.com";
    const redirectUri = "http://localhost:5173/auth/callback"; // تعديل البورت والمسار ليكون متناسق مع الفيت والـ callback
  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center p-8">
      <div className="w-full lg:w-[45vw] lg:w-1/2 bg-card rounded-xl p-10">
        {/* Title */}
        <h1 className="text-1xl font-semibold text-foreground">Welcome Back</h1>
